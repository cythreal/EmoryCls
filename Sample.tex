...
%          bracket: round, square, and plain
%          
...
\setkeys[emory]{bib}{bracket=plain}
\setkeys[emory]{bib}{articletitle=false}
\setkeys[emory]{bib}{doi=false}
\setkeys[emory]{bib}{superscript=true}
\setkeys[emory]{bib}{maxauthor=15}
