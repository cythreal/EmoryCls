...
% ------ abstract --------------------------------------------------------------
\begin{abstract}% specify size using option [size], default is 4.5in
...
The width of the abstract text can be specified by the command: 
\Verb|\begin{abstract}[size]|.
The default value is \Verb|4.5in| for a short abstract, such as this example.
A larger width can be chosen to include more text.
Due to the page size constraint, sizes larger than \Verb|6in| will be forced into \Verb|6in|.
...
of this class:
\begin{itemize}
  \item The American Chemical Society journal package \Verb|achemso|: \url{https://www.ctan.org/pkg/achemso?lang=en}
  \item \LaTeXe{} for class and package writers:  \url{https://www.ctan.org/pkg/clsguide}
...
archive at \url{https://www.ctan.org/}.
...
Note that \Verb|hyperref| has been known to create numerous compatibility warnings in this class.
